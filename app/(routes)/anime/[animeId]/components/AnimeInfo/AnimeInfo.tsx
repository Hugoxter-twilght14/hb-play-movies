...
const AnimeInfo: React.FC<AnimeInfoProps> = ({
  ...
  return (
    <div className="w-full px-6 md:px-12 pt-10 bg-zinc-900 text-white">
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <img
          src={thumbnailUrl}
          alt={title}
          className="w-full md:w-60 lg:w-72 rounded-lg shadow-lg object-cover"
        />
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <ActionButtonsPage filmId={id} type="anime" />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-300">
            ...
            {actores && (
              <p className="sm:col-span-2"><span className="font-semibold text-white">Actores:</span> {actores}</p>
            )}
          </div>
