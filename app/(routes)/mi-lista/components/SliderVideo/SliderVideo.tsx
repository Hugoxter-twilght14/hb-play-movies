  ...
  return (
    <div className="relative w-full h-[80vw] md:h-[56.25vw] lg:h-[45vw] flex items-center justify-center">
      ...
      >
        ...
        <p className="text-sm md:text-base lg:text-lg max-w-lg mb-6 uppercase font-semibold text-[#0B614B]">
          Todas tus peliculas favoritas, listas para ver y disfrutar.
          añade a tu lista todas la peliculas y series que te gustan y repitelas 
