  ...
  const onSubmit = async(values: z.infer<typeof formSchema>) => {
    try {
        ...
        if(response.status === 200){
            ...
            toast({title: "Ha ocurrido un error al crear tu perfil, intentalo de nuevo", variant: "destructive"});
        }
        router.refresh();
        setOpen(false);
    } catch (error) {
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="Sobrenombre o apodo" {...field} />
              </FormControl>
              <FormDescription>
                    ...
                    {dataProfilesImages.map((data) =>(
                        ...
                        >
                            ...
                            <FormLabel className="font-normal flex justify-center w-full">
                                ...
                                className={field.value === data.urlImage ? 
